...
<p align="center">
    <img src="image/track1_screenshot.png" width="360"/><br>
    Driving autonomously on track<br>
</p>
...
Use command `python drive.py model.h5` to initiate the automous mode in simulator.
